...
/// @notice Reserve adapter simply holds the underlying and returns it 1:1
contract ReserveAdapter is IStrategyAdapter, Ownable {
    ...
    modifier onlyManager() {
        require(msg.sender == manager || msg.sender == owner(), "RA: not mgr");
        _;
    }
